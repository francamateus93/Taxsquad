...
const Sidebar = () => {
  return (
    <>
      {/* Sidebar DESKTOP*/}
      <aside className="hidden md:flex md:flex-col md:fixed md:top-0 md:left-0 md:h-screen md:w-64 bg-emerald-50 shadow-md z-20">
        ...
        <nav className="flex-1 p-4">
          <ul className="space-y-3 font-medium">
            ...
            <li>
              <Link
                to="/dashboard"
                className="flex items-center px-6 py-2 rounded-lg hover:bg-emerald-200 transition duration-200"
              >
