...
const TaxesCard = ({ title, date, deadline, documentType }) => {
  ...
  return (
    <div className="bg-white shadow-[0_0px_5px_rgba(0,0,0,0.1)] hover:shadow-xl transition duration-300 rounded-xl px-10 py-6 md:p-10 space-y-4 max-w-4xl">
      <div className="flex flex-col gap-3 items-center">
        ...
        <p className="text-gray-500 mb-2 text-sm md:text-base tracking-tight">
